...
It is therefore relevant to provide an accurate description of the bremsstrahlung cross sections.

For electrons with high energies, \cite{2013zbq} recommends the usage of the Complete Screening parametrization which is already implemented in PROPOSAL.
...
This parametrization is implemented in PROPOSAL to examine the differences between the cross sections provided by PROPOSAL and EGS.
