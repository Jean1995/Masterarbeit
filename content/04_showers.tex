...
\begin{figure}
    ...
    \label{fig:compton}
\end{figure}
\todo{Three variants for the plot: 1. Ticklabels behind the grid and plot, 2. Grid infront of the plot but tick labels infront of the plot, 3. Neglect the (arbitrary)  polar axis altogether}
