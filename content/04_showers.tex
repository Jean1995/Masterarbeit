...
Under the assumption that the atomic electron is initially free and and rest, which is a good approximation for positrons with energies high compared to atomic binding energies, the differential annihilation cross section is described by the Heitler formula \cite{heitler1954quantum} given by \cite{Hirayama:2005zm}
%
\begin{equation}
...
\end{align*}
%
with the corresponding energies $E_i$, masses $m_i$ and absolute momenta $p_i$ of the particles involved, applying the conversation of four-momentum (i.e.\ conversation of energy and conversation of 3-space momentum) leads to the relation \cite{Hirayama:2005zm}
%
\begin{equation}
...
This requires adjustments to the simulation of the stochastic energy loss in the propagation algorithm in PROPOSAL described in section \ref{sec:algorithm}.
...
\end{align}
%
Furthermore, the photons inherit the propagation direction of the initial positron with an additional deflection of an polar angle $\theta$ according to \eqref{eqn:annihilation_angle_1} and \eqref{eqn:annihilation_angle_2} as well as an azimuth angle $\Phi$ sampled with
%
\begin{align}
...
Quantitatively, the annihilation interaction is, as well as the other processes, suppressed compared to the bremsstrahlung interaction.
