...
Positron-electron annihilation, only called annihilation in the further course of the chapter, describes the collision of a positron with an atomic electron where both particles annihilate and a pair of photons is created, i.e\ the process
%
\begin{align*}
...
Under the assumption that the atomic electron in initially free and and rest, which is a good approximation for positrons with energies high compared to atomic binding energies, the differential annihilation cross section is described by the Heitler formula \cite{heitler1954quantum} given by \cite{Hirayama:2005zm}
%
\begin{equation}
...
\end{equation}
%
Furthermore, setting $\cos(\theta_3) = \pm \num{1}$ in \ref{eqn:annihilation_angle} yields the kinematic limits for $\epsilon$
%
\begin{align}
...
Instead, the interaction is always stochastic and the relative energy loss of the initial positron is always $v=1$ for the annihilation process since all energy is transferred to the created photon pair.
