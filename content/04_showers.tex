...
However, the development of the original EGS code ended with the release of EGS4, although other working groups continued working on the given code foundation \cite{Hirayama:2005zm} \cite{Kawrakow2016TheEC}.
...
While the implementation of the first two processes is described in the following section, the photoelectric effect is neglected since its relevance is limited to energies $E \ll 2 m_e$.
