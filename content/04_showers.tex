...
Figure \ref{fig:dEdx_brems} shows a comparison of the average energy loss for electrons loss due to bremsstrahlung when using different differential cross sections.
