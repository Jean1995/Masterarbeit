...
During propagation of electrons and positrons, the original version of EGS4 takes into account bremsstrahlung effects, collision losses, M{\o}ller or Bhabha scattering, multiple scattering as well as annihilation (for positrons) while for photons, electron-positron pair production, Compton scattering as well as photonuclear interactions are considered.
...
For every propagated particle, all produced secondary particles are stored and propagated as well, creating a full electromagnetic shower.
...
While EGS4 is able to treat the deflection of charged leptons in magnetic fields, approximations only valid for small deflection angles are used.
...
Furthermore, thinning measures are taken by removing particles from propagation if their probability to produce relevant secondary particles falls below a certain threshold, preventing the calculation of irrelevant low-energy subshowers.