...
The software was originally developed to perform simulations for the extensive air showers experiment KASCADE with the first version of CORSIKA being released in October 1989 \cite{userguide}.
...
\subsection{Description of CORSIKA}
...
As described in the CORSIKA userguide \cite{userguide}, the basic software structure is based on four main parts.
...
Links to further descriptions of the individual models are provided by the CORSIKA userguide \cite{userguide}.
