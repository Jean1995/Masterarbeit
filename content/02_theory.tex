...
Instead, these extensions need to be developed to conform specifically with the existing complex code structure.
...
Furthermore, four building blocks, describing the very general code structure, are described.
